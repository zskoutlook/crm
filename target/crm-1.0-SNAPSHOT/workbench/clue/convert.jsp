	...
	$(function(){
		...
		$("#convertBtn").click(function () {
			if($("#isCreateTransaction").prop("checked")){
				//window.location.href="workbench/clue/convert.do?clueId=${param.id}&money=xxx&expectedDate=xxx&name=xxx&activityId=xxx"
				$("#tranForm").submit()
			}else {
...
<body>
	...
	<div id="title" class="page-header" style="position: relative; left: 20px;">
		<%--el表达式更简单--%>
		<h4>转换线索 <small><%= fullname %><%= appellation %>-${param.company}</small></h4>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="activityNameShow" placeholder="点击上面搜索" readonly>
